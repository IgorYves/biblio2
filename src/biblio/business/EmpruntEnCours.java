...
public class EmpruntEnCours implements Serializable {
	...
	public String toString() {
		...
		int daysEmprunt = (int) ((dayToday - dayEmprunt)
				/ (24 * 60 * 60 * 1000));
		return "[(Emprunt) dateEmprunt: " + dateEmprunt + " (" + daysEmprunt
				+ " jour(s))" + "; emprunteur: " + emprunteur.getNom()
				+ "; exemplaire: " + exemplaire.getIdExemplaire() + ", "
				+ exemplaire.getAuteur() + ", " + exemplaire.getTitle() + "]";
	}
